...
class BedRoomWidget extends HookWidget {
  BedRoomWidget(
 ...
 */
    ...
    //propery facade
    final newImageList = useState(getStringAsync('k5Bedroom1Picture$listValue', defaultValue: ''));
    ...
    final bathTiles =
        useState(getStringAsync('k5Bedroom1WallTiles$listValue', defaultValue: 'Satisfactory'));
    final bathFloor =
        useState(getStringAsync('k5Bedroom1FloorTiles$listValue', defaultValue: 'Satisfactory'));
    final bathVanity =
        useState(getStringAsync('k5Bedroom1Vanity$listValue', defaultValue: 'Satisfactory'));
    final bathShower =
        useState(getStringAsync('k5Bedroom1Shower$listValue', defaultValue: 'Satisfactory'));
    final bathWaste =
        useState(getStringAsync('k5Bedroom1FloorWaste$listValue', defaultValue: 'Satisfactory'));
    final bathDoor =
        useState(getStringAsync('k5Bedroom1Door$listValue', defaultValue: 'Satisfactory'));
    final bathWindow =
        useState(getStringAsync('k5Bedroom1Window$listValue', defaultValue: 'Satisfactory'));

    final noteLiving = useTextEditingController(
        text: getStringAsync('k5Bedroom1Note$listValue', defaultValue: ''));
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (index != 1)
            GestureDetector(
              onTap: () => showConfirmDialog(context, 'Delete Bedroom $index',
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Bedroom1WallTiles$listValue', value);
                /*  setState(() {
                      bathTiles = value;
                    }); */
              },
              items: bedroomList.map<DropdownMenuItem<String>>((value) {
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Bedroom1FloorWaste$listValue', value);
                /*  setState(() {
                      bathWaste = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Bedroom1FloorTiles$listValue', value);
                /*  setState(() {
                      bathFloor = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Bedroom1Vanity$listValue',
                    value); /* setState(() {
                      bathVanity = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Bedroom1Shower$listValue', value);
                /* setState(() {
                      bathShower = value;
                    }); */
              },
              ...
              children: [
                GestureDetector(
                  onTap: () async {
                    ...
                    setValue('k5Bedroom1Picture$listValue', addedString);
          ...
          MultiSelectDropdown.simpleList(
            list: bedroomDefectList,
            initiallySelected:
                jsonDecode(sharedPreferences.getString("k5Bedroom1Defects$listValue").toString()) ??
                    [],
            onChange: (newList) {
              sharedPreferences.setString('k5Bedroom1Defects$listValue', jsonEncode(newList));
              debugPrint(
                  "----------> ${jsonDecode(sharedPreferences.getString("k5Bedroom1Defects$listValue").toString())}");
            },
            isLarge: true,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                setValue('k5Bedroom1Note$listValue', value);
              },
              validator: (value) {
                if (value!.isEmpty) {
