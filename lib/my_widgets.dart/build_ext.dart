...
class BuildExtRoomWidget extends HookWidget {
  ...
  List<String> exteriorDefectList = [
   ...
   "Evidence of cracking to property foundations/piers. Is non structural but should be monitored going forward.",
   "Evidence of cracking to property foundations/piers. Is a structural issue and I recommend services of a structural engineer.",
   "Down pipes are draining direct to ground and should be conn3cted to storm water system. See plumber for advice.",
  ];
  @override
      ...
      child: Column(
         ...
         */
          ...
          MultiSelectDropdown.simpleList(
            list: exteriorDefectList,
            initiallySelected: jsonDecode(sharedPreferences.getString("k5exterior1Defects$listValue").toString()) ?? [],
            onChange: (newList) {
              sharedPreferences.setString('k5exterior1Defects$listValue', jsonEncode(newList));
              debugPrint("----------> ${jsonDecode(sharedPreferences.getString("k5exterior1Defects$listValue").toString())}");
            },
            isLarge: true,
