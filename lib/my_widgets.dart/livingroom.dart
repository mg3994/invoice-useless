      ...
      child: Column(
       ...
       /*    const Gap(20),
          ...
          MultiSelectDropdown.simpleList(
            list: livingDefectList,
            initiallySelected: jsonDecode(sharedPreferences.getString("k5living1Defects$listValue").toString()) ?? [],
            onChange: (newList) {
              sharedPreferences.setString('k5living1Defects$listValue', jsonEncode(newList));
              debugPrint("----------> ${jsonDecode(sharedPreferences.getString("k5living1Defects$listValue").toString())}");
